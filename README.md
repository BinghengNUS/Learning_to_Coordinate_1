...
To reproduce the 6s (3-drone) and 5s (6-drone) flight trajectories used in the experiments, run the Python files '**main_load_kinodynamic_planner_ADMM_DDP_2nd_evaluation_COM_Dyn_HV**' and '**main_load_kinodynamic_planner_ADMM_DDP_2nd_evaluation_COM_Dyn_V_6**', respectively.
